...
// from https://imagej.nih.gov/ij/developer/source/ij/plugin/tool/BrushTool.java.html	 
...
public class BrushToolCustom extends PlugInTool implements Runnable {
    ...
    private static BrushToolCustom brushInstance;
    ...
    public void run(String arg) {
        ...
        paintOnOverlay = Prefs.get(OVERLAY_KEY, true);
    ...
    private void checkForOverlay(ImagePlus imp) {
        ...
        if (overlayImage==null && paintOnOverlay) {
            ...
            imageRoi.setName(String.valueOf(123456789));
